import '@converse/staytus/plugins/muc/index.js';
...
const Bookmarks = {
  ...
  sendBookmarkStanza() {
    ...
    stanza
      ...
      .c('value')
      .t('http://jabber.org/protocol/pubsub#publish-options')
      .up()
      .up()
  ...
  onBookmarkError(iq, options) {
    ...
    api.alert('error', __('Error'), [
      __('Sorry, something went wrong while trying to save your bookmark.'),
    ]);
